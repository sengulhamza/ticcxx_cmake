...
# core flags
set(CORE_FLAGS "-mthumb -mcpu=cortex-m3 -mfloat-abi=soft -mthumb-interwork --specs=nano.specs --specs=nosys.specs -g '-D__weak=__attribute__((weak))' ${ADDITIONAL_CORE_FLAGS}")

# compiler: language specific flags
set(CMAKE_C_FLAGS "${CORE_FLAGS} -fno-builtin -Wall -Wno-unused-parameter -std=c99 -fdata-sections -ffunction-sections -g3 -gdwarf-2 -u _scanf_float -u _printf_float" CACHE INTERNAL "c compiler flags")
